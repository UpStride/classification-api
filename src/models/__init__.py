...
model_name_to_class = {
    ...
    "MobileNetV3LargeNCHW": MobileNetV3LargeNCHW,
    "MobileNetV3SmallNCHW": MobileNetV3SmallNCHW,
    "MobileNetV3LargeCIFARNCHW": MobileNetV3LargeCIFARNCHW,
    "MobileNetV3SmallCIFARNCHW": MobileNetV3SmallCIFARNCHW,
    # Hyper Model
